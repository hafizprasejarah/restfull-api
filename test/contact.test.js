...
import { createTestUser, removeAllTestContacts, createTestContact, getTestContact, createManyTestContact } from "../test/test-util.js";
...
describe('GET /api/contacts', function () {
    ...
    it("can search by the name", async () => {
        const result = await supertest(web)
            .get('/api/contacts')
            .query({
                name: 'test 1'
    ...
    it("can search by the email", async () => {
        const result = await supertest(web)
            .get('/api/contacts')
            .query({
                email: 'contact1'
    ...
    it("can search by the phone", async () => {
        const result = await supertest(web)
            .get('/api/contacts')
            .query({
                phone: '081234567891'
